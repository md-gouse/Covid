...
public class MainActivity extends Superclass implements AdapterView.OnItemSelectedListener{
    ...
    PieChart mpiechart;
    com.example.covid_alert.Adapter adapter;
    ...
    private void updateGraph(int active, int total, int recovered, int deaths) {
        ...
        mpiechart.addPieSlice(new PieModel("Confirm", total, Color.parseColor("#FFC300")));
        mpiechart.addPieSlice(new PieModel("Active", active, Color.parseColor("#FF4CAF50")));
        mpiechart.addPieSlice(new PieModel("Recovered", recovered, Color.parseColor("#047BD5")));
